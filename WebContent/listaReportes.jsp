...
<head>
	...
	<script>
		WebFont.load({
			...
			custom: {
				...
				urls: ['<%=request.getContextPath()%>/assets/fonts.min.css']
			},
			active: function () {
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/assets/atlantis.min.css">
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				<a href="index.html" class="logo">
					<img src="<%=request.getContextPath()%>/assets/img/logo.svg" alt="navbar brand" class="navbar-brand">
				</a>
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
								aria-expanded="false">
								<div class="avatar-sm">
									<img src="<%=request.getContextPath()%>/assets/img/profile.jpg" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="<%=request.getContextPath()%>/assets/img/profile.jpg"
									...
									<li>
										...
										<a class="dropdown-item" href="../sign-in/singin.html">Logout</a>
									</li>
								</div>
							</ul>
						</li>
											...
											<tbody>
												...
												<tr class="text-center">
													...
													<td><button type="button"
															onclick="location.href='tokens?reporte=<%=r.getId()%>'"
															class="btn btn-dark">Ver Tokens</button></td>
													<td><button type="button"
															onclick="location.href='seguimientos?reporte=<%=r.getId()%>'"
															class="btn btn-dark">Ver Seguimientos</button></td>
