...
<!-- Fonts and icons -->
<script
	src="<%=request.getContextPath()%>/assets/js/plugin/webfont/webfont.min.js"></script>
<script>
		WebFont.load({
			google: {
...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/assets/css/atlantis.min.css">
...
<body>
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				<a href="index.html" class="logo"> <img
					src="<%=request.getContextPath()%>/assets/img/logo.svg"
		...
		List<Connectiontoken> tokens = (List) request.getAttribute("tokens");
		%>
					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-3">
							<div class="card card-stats card-primary card-round">
								<div class="card-body">
									<a href="informacion-basica.html" alt="Docentes"
										class="anonstyle">
										<div class="row">
											<div class="col-5">
											...
											<div class="col-7 col-stats">
												<div class="numbers">
													...
													<h4 class="card-title"><%=reportes.size()%></h4>
												</div>
											</div>
										</div>
									</a>
						...
						<div class="col-sm-6 col-md-3">
							<div class="card card-stats card-info card-round">
								<div class="card-body">
									<a href="pensum.html" alt="Pensum" class="anonstyle">
										<div class="row">
											<div class="col-5">
												<div class="icon-big text-center">
											...
											<div class="col-7 col-stats">
												<div class="numbers">
													...
													<h4 class="card-title"><%=tokens.size()%></h4>
												</div>
											</div>
										</div>
									</a>
	...
	<!-- Chart Circle -->
	<script
		src="<%=request.getContextPath()%>/assets/js/plugin/chart-circle/circles.min.js"></script>

	<!-- Datatables -->
	<script
		src="<%=request.getContextPath()%>/assets/js/plugin/datatables/datatables.min.js"></script>

	<!-- jQuery Vector Maps -->
	<script
		src="<%=request.getContextPath()%>/assets/js/plugin/jqvmap/jquery.vmap.min.js"></script>
	<script
		src="<%=request.getContextPath()%>/assets/js/plugin/jqvmap/maps/jquery.vmap.world.js"></script>

	<!-- Sweet Alert -->
	<script
		src="<%=request.getContextPath()%>/assets/js/plugin/sweetalert/sweetalert.min.js"></script>
