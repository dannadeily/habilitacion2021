...
<body>
    ...
    <div class="cuerpologin">
        ...
        <div class=" row d-flex justify-content-center">
         <form class="w-75" method="post" action="/administrador/registroBases/enviar">
                <div class=" fbr plogin  gbcolor">
                    ...
                    <div class="mb-3 row w-100 d-flex justify-content-center align-items-center">
                        <div class="col-6">
                            <h3>Driver</h3>
                            <input type="text" class="col form-control singin" name="driver" placeholder="Driver" id="" required>
                            <br>
                            <h3>Adicional</h3>
                            <input type="text" class="col form-control singin" name="aditional" placeholder="Adicional" id="" required>
                            <br>
                            <h3>Descripcion</h3>
                            <input type="text" class="col form-control singin"   name="description" placeholder="Descripcion" id=""
                                required>
                            <br>
                        </div>
                        <!--botones-->
